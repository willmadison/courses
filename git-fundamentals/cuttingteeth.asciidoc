...
So we can see that something changed, but what exactly changed in that untracked file?
...
Execute `git diff` in your terminal to see a picture of what has been modified in your working tree/directory.
